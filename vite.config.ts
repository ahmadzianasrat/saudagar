  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // (Previously excluded jsPDF's optional html2canvas/DOMPurify
        // chunks here, back when receipts were PDF-based — jsPDF is
        // gone now in favor of html-to-image, which has no such
        // heavy optional dependency, so there's nothing worth
        // excluding from precache anymore.)
      },
    }),
  ],
});
